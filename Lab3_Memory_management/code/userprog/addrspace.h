...
class AddrSpace {
  ...
  private:
    ...
    {
      return pageTable[virtualAddr/PageSize].physicalPage * PageSize + virtualAddr % PageSize;
    }

    static int restPlace(int virtualAddr) { return PageSize - virtualAddr % PageSize; }
};
